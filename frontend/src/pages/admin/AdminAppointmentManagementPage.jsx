  ...
  const handleUpdateStatus = async (id, newStatus, reason = '') => {
    try {
      await updateStatusMutation.mutateAsync({
        id,
        payload: { status: newStatus, reason, note: 'Cập nhật từ Admin Portal' }
      });
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Tra cứu và quản lý toàn bộ lịch hẹn khám bệnh trong hệ thống</p>
      </div>
